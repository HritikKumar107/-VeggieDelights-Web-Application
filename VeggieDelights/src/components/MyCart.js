...
export default function MyCart(){
    return(
        <>
        <Header active={'mycart'}/>
        <div className="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
            <div className="container">
                <h1 className="display-3 mb-3 animated slideInDown">My Cart</h1>
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol className="breadcrumb mb-0">
                        ...
                        <li className="breadcrumb-item text-dark active" aria-current="page">My Cart</li>
                 </ol>
                </nav>
            </div>
        </div>

    <section class="shoping-cart spad wow fadeInOut" data-wow-delay="0.5s">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
